...
/* DESCRIPTION :                                                              */
/** \file
    mapping for PORTS and configurations.
...
/*----------------------------------------------------------------------------*/
/* JOSÉ ANTONIO V.T    |       1            | MAPPING OF MC S32K144           */
/*                     |                    |                                 */
/*============================================================================*/
/*                               OBJECT HISTORY                               */
/*============================================================================*/
...
typedef struct{
	...
	T_ULONG TOVAL;
	T_ULONG WIN;
}S_WDOG; //Watchdog timer

#define WDOG_BASE_ADDRESS    0x40052000 //Address direction of WDOG register
